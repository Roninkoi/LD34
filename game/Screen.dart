...
class Screen {
	...
	void drawGUI()
	{
		...
		if ((swingticks > pi) && (walkerswing.x < 0.05 && walkerswing.x > -0.05)) {
			walkerswing.x = 0.0;
		}
		if ((swingticks > pi) && (walkerswing.y < 0.05 && walkerswing.y > -0.05)) {
			walkerswing.y = 0.0;
		}
		...
		swingticks += (0.5/3.0);
		if ((swingticks <= pi) || walkerswing.x != 0.0) walkerswing.x = (cos(swingticks));
		if ((swingticks <= pi) || walkerswing.y != 0.0) walkerswing.y = -(sin(swingticks)*0.5).abs();
